...
const Wheel = ({
  ...
  useInterval(() => {
    timer();
  }, spinTime); //setting the interval to run the timer() function
  ...
  return (
    ...
    spinning ? (
      <div>
        ...
        <div className="wheel">
          <SpinText className="wheel-animate">{selection}</SpinText>
        </div>

        <div>
          {/**Button used to stop the data from spinning */}
          <WheelButton className="spin-button" onClick={() => change()}>
            STOP
          </WheelButton>
    ...
    selection === null ? (
      <div>
        ...
        <div>
          ...
          <button className="button-slide spin-button" onClick={() => change()}>
            SPIN
          </button>
        </div>
      </div>
